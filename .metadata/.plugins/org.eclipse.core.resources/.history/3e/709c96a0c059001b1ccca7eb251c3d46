...
public class Steps {
	...
	public Steps addToBasket(){
		...
		wait.until(ExpectedConditions.presenceOfElementLocated((By.cssSelector("a.btn.btn-default.button.button-medium"))));
